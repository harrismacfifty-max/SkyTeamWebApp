...
- Das Standardprofil `demo` nutzt In-Memory-Daten, damit lokal keine Oracle-Installation erforderlich ist. `dev` bleibt als Alias fuer lokale Altstarts erhalten.
