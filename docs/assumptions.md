...
- Die Demo-Schüler `SC901` bis `SC907` besitzen die Konten `sc901/demo901` bis `sc907/demo907` und dürfen jeweils nur den eigenen Ausbildungsprozess bearbeiten.
- `demo/demo` bleibt ausschließlich als nicht empfohlener Legacy-Alias eindeutig `SC901` zugeordnet; Präsentation und neue Abläufe verwenden `sc901/demo901`.
...
- Alle Demo-Konten sind nur in den Profilen `demo` und `dev` aktiv, nicht im Profil `oracle`.
